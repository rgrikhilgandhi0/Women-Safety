						...
						<div class="widget box">
							...
							<div class="widget-content">
								<table
									...
									<tbody>
										<c:forEach items="${sessionScope.lsLocation}" var="location">
										<tr>
											<td>${location.locationId}</td>
											<td>${location.locationName}</td>
											<td>${location.locationDescription}</td>
											<td><a href="<%=request.getContextPath()%>/LocationController?locationId=${location.locationId}&flag=editLocation"><input type="button" value="Edit"></a><input type="button" value="Delete"></td>
										</tr>
										</c:forEach>
