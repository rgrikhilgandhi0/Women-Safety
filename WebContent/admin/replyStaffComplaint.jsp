...
<title>Reply Staff Complaint</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Reply Staff Complaint
								</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									action="<%=request.getContextPath()%>/StaffComplaintController"
									method="post">
									<c:forEach items="${sessionScope.replyls}" var="staffComplaint">

										<input type="hidden" name="staffComplaintId"
											value="${staffComplaint.staffComplaintId}">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" name="subject"
													value="${staffComplaint.subject}"
													class="form-control required">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Complaint
												Description <span class="required">*</span>
											</label>
											<div class="col-md-9">
												<!-- <input type="textarea" rows="3" cols="5" name="areaDescription" value="${area.areaDescription}" class="form-control required"> -->
												<textarea rows="3" cols="5" name="complaintDescription"
													value="${staffComplaint.complaintDescription}"
													class="form-control">${staffComplaint.complaintDescription}</textarea>
											</div>
										</div>
										<c:forEach items="${sessionScope.attachmentList}"
											var="staffComplaint">
											<div class="form-group">
												<label class="col-md-3 control-label">Attachment<span
													class="required">*</span></label>
												<div class="col-md-9">
													<img alt="${staffComplaint.attachmentFileName}"
														src="<%=request.getContextPath()%>//StaffAttachment//${staffComplaint.attachmentFileName}">
												</div>
											</div>
										</c:forEach>
										<div class="form-group">
											<label class="col-md-3 control-label">Reply<span
												class="required">*</span></label>
											<div class="col-md-9">
												<textarea rows="3" cols="5" name="reply"
													class="form-control"></textarea>
											</div>
										</div>
										<input type="hidden" name="toUserID"
											value="${staffComplaint.from.loginId}" />
										<input type="hidden" name="flag" value="insertReply" />
