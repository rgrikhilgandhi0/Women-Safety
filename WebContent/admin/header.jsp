<header class="header navbar navbar-fixed-top" role="banner">
	<div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<!-- <li class="dropdown hidden-xs hidden-sm"><a href="#"
					...
					<ul class="dropdown-menu extended notification">
						...
						<li><a href="javascript:void(0);"> <span class="photo"><img
									src="img/avatar-1.jpg" alt="" /></span> <span class="subject">
									<span class="from">Bob Carter</span> <span class="time">Just
										Now</span>
							</span> <span class="text"> Consetetur sadipscing elitr... </span>
						</a></li>
						<li><a href="javascript:void(0);"> <span class="photo"><img
									src="img/avatar-2.jpg" alt="" /></span> <span class="subject">
									<span class="from">Jane Doe</span> <span class="time">45
										mins</span>
							</span> <span class="text"> Sed diam nonumy... </span>
						</a></li>
						<li><a href="javascript:void(0);"> <span class="photo"><img
									src="img/avatar-3.jpg" alt="" /></span> <span class="subject">
									<span class="from">Patrick Nilson</span> <span class="time">6
										hours</span>
			...
			<li class="dropdown user"><a href="../login.jsp?flag=logout">
					<i class="icon-male"></i> <span class="username">Log Out</span>
						...
						<li class="divider"></li>
						<li><a href="../login.jsp?flag=logout"><i class="icon-key"></i>Log Out</a>
						</li>
					</ul> --></li>
		</ul>
	</div>
		...
		<div id="frame">
			<ul class="project-list">
				...
				<li class="current"><a href="javascript:void(0);"> <span
						class="image"><i class="icon-male"></i></span> <span class="title">Consetetur
