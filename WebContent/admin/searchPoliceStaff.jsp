...
<%@ page import="controller.PoliceStaffController" %>
...
<title>search_police_staff</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Police Staff
								</h4>
							...
							<div class="widget-content">
								<table
									...
									<tbody>
										<c:forEach items="${sessionScope.ls}" var="policeStaff">
										<tr>
											<td>${policeStaff.policeStaffId}</td>
											<td>${policeStaff.policeName}</td>
											<td>${policeStaff.postVO.postName}</td>
											<td>${policeStaff.policeStationVO.policeStationName}</td>
											<td>${policeStaff.areaVO.areaName}</td>
											<td>${policeStaff.experience}</td>
											<td>${policeStaff.contactNo}</td>
											<%-- <td>${policeStaff.emailId}</td> --%>
											<td>${policeStaff.achievements}</td>
											
											<!-- <td>Joey</td>
											<td>Greyson</td>
											<td class="hidden-xs">joey123</td> -->
											<td><a href="<%=request.getContextPath()%>/PoliceStaffController?policeStaffId=${policeStaff.policeStaffId}&flag=editPoliceStaff"><input type="button" value="Edit"></a><input type="button" value="Delete"></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
