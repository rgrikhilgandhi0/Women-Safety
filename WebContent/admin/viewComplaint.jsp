...
<%@page import="controller.ComplaintController" %>
						...
						<div class="widget box">
							...
							<div class="widget-content">
								<table
									...
									<tbody>
										<c:forEach items="${sessionScope.lsComplaint}" var="lsComplaint">
										<tr>
											<td>${lsComplaint.complaintId}</td>
											<td>${lsComplaint.subject}</td>
											<td>${lsComplaint.complaintDescription}</td>
											<td><a href="<%=request.getContextPath()%>/ComplaintController?complaintId=${lsComplaint.complaintId}&flag=replyComplaint"><input type="button" value="Reply"></a></td>
										</tr>
										</c:forEach>
