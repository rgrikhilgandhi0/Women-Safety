					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Add Post
								</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="postName" required="" class="form-control required">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label" required="">Post Description <span
											class="required">*</span></label>
										<div class="col-md-9">
											<textarea rows="3" cols="5" name="postDescription" required=""
