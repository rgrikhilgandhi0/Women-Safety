								...
								<table
									...
									<thead>
										<tr>
											...
											<th>Area Name</th>
											<th>Area Pincode</th>
											<th class="hidden-xs">Area Description</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${sessionScope.ls}" var="area">
										<tr>
											<td>${area.areaId}</td>
											<td>${area.areaName}</td>
											...
											<td><a href="<%=request.getContextPath()%>/AreaController?areaId=${area.areaId}&flag=editArea"><input type="button" value="Edit"></a><input type="button" value="Delete"></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
