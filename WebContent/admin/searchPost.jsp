						...
						<div class="widget box">
							...
							<div class="widget-content">
								<table
									...
									<tbody>
									<c:forEach items="${sessionScope.ls}" var="post">
										<tr>
										<td>${post.postId}</td>
											<td>${post.postName}</td>
											...
											<td><a href="<%=request.getContextPath()%>/PostController?postId=${post.postId}&flag=editPost"><input type="button" value="Edit"></a><input type="button" value="Delete"></td>
										</tr>
