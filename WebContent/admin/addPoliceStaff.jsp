					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Add Police Staff
								</h4>
							</div>
							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="policeName" required="" class="form-control required">
										</div>
										</div>
										<div class="form-group">
										<label class="col-md-3 control-label">Post<span
											class="required">*</span></label>
										<div class="col-md-9">
											<select name="postId" class="form-control required" required="required">		
													<option value="">Choose one...</option>
											<c:forEach items="${sessionScope.lsPost}" var="lsPost">		
													<option value="${lsPost.postId}">${lsPost.postName}</option>
											</c:forEach>
											</select>
										</div>
									</div>
										...
										<label class="col-md-3 control-label">Police Station<span
											class="required">*</span></label>
										<div class="col-md-9">
											<select name="policeStationId" class="form-control required" required="required">
											<option value="">Choose one...</option>
										...
										<label class="col-md-3 control-label">Experience <span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="experience" required="" class="form-control required">
										</div>
										</div>
										...
										<label class="col-md-3 control-label">Contact No. <span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="contactNo" required="" class="form-control required">
										</div>
										</div>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Achievements <span
											class="required">*</span></label>
										<div class="col-md-9">
											<textarea rows="3" cols="5" name="achievements" required="" class="form-control"></textarea>
										</div>
									</div>
									<input type="hidden" name="flag" value="insertPoliceStaff" />
