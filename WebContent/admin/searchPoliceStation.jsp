...
<title>search_police_station</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Police Station
								</h4>
							...
							<div class="widget-content">
								<table
									...
									<tbody>
									<c:forEach items="${sessionScope.lsPoliceStation}" var="policeStation">
										<tr>
											<td>${policeStation.policeStationId}</td>
											<td>${policeStation.policeStationName}</td>
											<td>${policeStation.policeStationAddress}</td>
											<td>${policeStation.policeStationContactNo}</td>
											<td>${policeStation.prisonDescription}</td>
											<td>${policeStation.areaVO.areaName}</td>		
											<td><a href="<%=request.getContextPath()%>/PoliceStationController?policeStationId=${policeStation.policeStationId}&flag=editPoliceStation"><input type="button" value="Edit"></a><input type="button" value="Delete"></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
