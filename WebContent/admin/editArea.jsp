					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Edit Area
								</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									action="<%=request.getContextPath()%>/AreaController" method="post">
									<c:forEach items="${sessionScope.editls}" var="area">
									
									<input type="hidden" name="areaId" value="${area.areaId}">
									
									<div class="form-group">
										<label class="col-md-3 control-label">Area Name <span
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Area Pincode <span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="areaPincode" value="${area.areaPincode}" class="form-control required">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Area Description <span
											class="required">*</span></label>
										<div class="col-md-9">
										<!-- <input type="textarea" rows="3" cols="5" name="areaDescription" value="${area.areaDescription}" class="form-control required"> -->
											<textarea rows="3" cols="5" name="areaDescription" value="${area.areaDescription}" 
												class="form-control">${area.areaDescription}</textarea> 
										</div>
									</div>
