...
<title>Add Staff Complaint</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Add Staff Complaint
								</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									action="<%=request.getContextPath()%>/StaffComplaintController" method="post" enctype="multipart/form-data">
									...
									<input type="hidden" name="flag" value="insertStaffComplaint" />
