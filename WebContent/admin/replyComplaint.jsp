					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Reply Complaint
								</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									action="<%=request.getContextPath()%>/ComplaintController" method="post">
									<c:forEach items="${sessionScope.replyls}" var="complaint">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Complaint Description <span
											class="required">*</span></label>
										<div class="col-md-9">
										<!-- <input type="textarea" rows="3" cols="5" name="areaDescription" value="${area.areaDescription}" class="form-control required"> -->
											<textarea rows="3" cols="5" name="complaintDescription" value="${complaint.complaintDescription}" 
												class="form-control">${complaint.complaintDescription}</textarea> 
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Reply<span
											class="required">*</span></label>
										<div class="col-md-9">
											<textarea rows="3" cols="5" name="reply" class="form-control"></textarea> 
										</div>
									</div>
									--${complaint.from.loginId}
									<input type="hidden" name="toUserID" value="${complaint.from.loginId}" />
