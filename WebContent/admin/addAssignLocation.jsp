...
<title>Add Assign Location</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Add Assign Location
								</h4>
							</div>
							<div class="widget-content">
								...
								<form class="form-horizontal row-border" id="validate-1"
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Police Station<span class="required">*</span></label>
										<div class="col-md-9">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
										<select name="locationId" class="form-control required" required="required">
											<option value="">Choose one...</option>
									...
									<input type="hidden" name="flag" value="insertAssignLocation" />
