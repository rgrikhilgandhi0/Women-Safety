					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>View Feedback
								</h4>
							...
							<div class="widget-content">
								<table
									...
									<tbody>
									<c:forEach items="${sessionScope.lsFeedback}" var="feedback">
										<tr>
											<td>${feedback.feedbackId}</td>
											
											<td>${feedback.feedbackDescription}</td>
											<td><a href="<%=request.getContextPath()%>/FeedbackController?flag=searchFeedback"><!-- <input type="button" value="Edit"><input type="button" value="Delete"></a> --></td>
										</tr>
