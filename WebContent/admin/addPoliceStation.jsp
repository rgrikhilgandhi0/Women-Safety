							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									...
									<div class="form-group">
										<label class="col-md-3 control-label" required="">Police Sation Name <span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="policeStationName" class="form-control required" required="">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label" required="">Police Station Address<span
											class="required">*</span></label>
										<div class="col-md-9">
											<textarea rows="3" cols="5" name="policeStationAddress" required=""
												class="form-control"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label" required="">Area<span
											class="required">*</span></label>
										<div class="col-md-9">
											<select name="areaId" class="form-control required" required="required">		
													<option value="">Choose one...</option>
											<c:forEach items="${sessionScope.lsArea}" var="lsArea">		
													<option value="${lsArea.areaId}">${lsArea.areaName}</option>
											</c:forEach>
											</select>
									...
									<div class="form-group">
										<label class="col-md-3 control-label" required="Field is Mandatory">Police Station Contact No. <span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="policeStationContactNo" class="form-control required" required="Field is Mandatory">
										</div>
									</div>
																		
									<div class="form-group">
										<label class="col-md-3 control-label" required="">Prison Description <span
											class="required">*</span></label>
										<div class="col-md-9">
											<textarea rows="3" cols="5" name="prisonDescription" required=""
												class="form-control"></textarea>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-md-3 control-label" required="">Latitude<span
											class="required">*</span></label>
										<div class="col-md-9">
									...
									<div class="form-group">
										<label class="col-md-3 control-label" required="Field is mandatory">Longitude<span
											class="required">*</span></label>
										<div class="col-md-9">
									...
									<input type="hidden" name="flag" value="insertPoliceStation"/>
