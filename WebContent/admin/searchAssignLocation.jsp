...
<title>search_assign_location</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Assign Location
								</h4>
							...
							<div class="widget-content">
								<table
									...
									<tbody>
									<tbody>
									<c:forEach items="${sessionScope.ls123 }" var="assignLocation">
										<tr>
									
										<td>${assignLocation.assignLocationId}</td>
									    <td>${assignLocation.policeStationVO.policeStationName}</td>
										    <td>${assignLocation.locationVO.locationName}</td>
							<td><a href="<%=request.getContextPath()%>/AssignLocationController?assignLocationId=${assignLocation.assignLocationId}&flag=editAssignLocation"><input type="button" value="Edit"></a><input type="button" value="Delete"></td> 
