					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Edit Post
								</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-1"
									action="<%=request.getContextPath()%>/PostController" method="post">
									<c:forEach items="${sessionScope.editls}" var="post">
									
									<input type="hidden" name="postId" value="${post.postId}">
									
									<div class="form-group">
										<label class="col-md-3 control-label">Post Name <span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="postName" value="${post.postName}" class="form-control required">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Post Description <span
											class="required">*</span></label>
										<div class="col-md-9">
											<textarea rows="3" cols="5" name="postDescription" value="${post.postDescription}"
