<%@page import="controller.StaffComplaintController"%>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Staff Complaint's
								</h4>
							...
							<div class="widget-content">
								<table
									...
									<thead>
										<tr>
											<th>Staff Complaint ID</th>
											<th>Subject</th>
											<th class="hidden-xs">Complaint Description</th>
											<th>EmailId</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${sessionScope.searchls}" var="staffComplaint">
										<tr>
											<td>${staffComplaint.staffComplaintId}</td>
											<td>${staffComplaint.subject}</td>
											<td>${staffComplaint.complaintDescription}</td>
											<td>${staffComplaint.from.emailId}</td>
											<td><a href="<%=request.getContextPath()%>/StaffComplaintController?staffComplaintId=${staffComplaint.staffComplaintId}&flag=replyStaffComplaint"><input type="button" value="Reply"></a></td>											
										</tr>
										</c:forEach>
									</tbody>
								</table>
