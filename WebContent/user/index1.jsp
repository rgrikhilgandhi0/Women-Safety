...
<!-- 
				...
				<div>
                	<button name="login" value="Login"></button> <button name="registration" value="Registration"></button>
                </div>
 -->
            ...
            <div class="container">
                <nav class="nav">
                    <ul class="sf-menu">
                        ...
                        <li>
                            <a href="contactUs.jsp">Sign up</a>
                ...
                <div data-src="img/honorToServeYou.jpg">
                    <div class="camera_caption fadeIn">
                        <div class="container">
                            <div class="row">
                                <div class="grid_8">
                                    <h2>It's an honor for us to serve you</h2>
                                    <h5> </h5>
